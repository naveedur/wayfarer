...
const BlogPost = () => {
  ...
  const tripSelector = useSelector((state) => state.getTrips);
  const trip = useMemo(() => tripSelector.trip, [tripSelector]);
          ...
          <form method="post" onSubmit={handleSubmit} className="postForm">
            ...
            <div className="form-group">
              ...
              <JoditEditor
                ...
                cols="30"
                rows="10"
                placeholder="Describe your experience about the place where you have visited"
              ></JoditEditor>
            </div>
