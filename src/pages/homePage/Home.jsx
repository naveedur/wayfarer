      ...
      <div className='home'>
        ...
        <div className='posts'>
          <div className='row container'>
            <h3 className='destinationHeading'>Destinations</h3>
            <hr />
            {tripList.length > 0 &&
              tripList.slice(0, 2).map((trip) => (
            ...
            <Link className='moreButton' to='/trips'>
              More Trips
            </Link>
          </div>
        </div>
        ...
        <div className='ceo'>
          <h3>
            Our Management will be personally available for all hours of the day for you. NO EXCEPTIONS. You will have
            his personal contact Info throughout your trip (and beyond).
          </h3>
        ...
        <div className='posts'>
          <div className='row container'>
            ...
            <Link className='moreButton' to='/blogs'>
              More Blogs
            </Link>
          </div>
        </div>
